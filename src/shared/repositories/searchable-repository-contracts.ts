...
export class SearchParams<Filter = string> {
  ...
  protected _sortDir: SortDirection | null | undefined;
  protected _filter: Filter | null | undefined;

  constructor(props: SearchProps<Filter> = {}) {
    this.page = props.page ?? 1;
    this.perPage = props.perPage ?? this._perPage;
    this.sort = props.sort ?? this.sort;
    this.sortDir = props.sortDir ?? this.sortDir;
